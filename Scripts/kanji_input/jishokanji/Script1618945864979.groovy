...
WebUI.setText(findTestObject('jisho_jpkanji_write/Page_Jisho.org Japanese Dictionary/input'), '青い', FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('jisho_jpkanji_write/Page_Jisho.org Japanese Dictionary/search'), FailureHandling.CONTINUE_ON_FAILURE)
