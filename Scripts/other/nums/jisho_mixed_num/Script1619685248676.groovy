...
WebUI.verifyElementPresent(findTestObject('jisho_mixed_num/Page_10 - Jisho.org/res_word'), 0, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('jisho_mixed_num/Page_10 - Jisho.org/res_kanji'), 0, FailureHandling.CONTINUE_ON_FAILURE)
