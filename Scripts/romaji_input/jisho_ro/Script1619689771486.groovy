...
WebUI.verifyElementPresent(findTestObject('jisho_hiragana/Page_aoi - Jisho.org/res_meaning'), 0)

WebUI.verifyElementPresent(findTestObject('jisho_hiragana/Page_aoi - Jisho.org/found_kanji'), 0)
